...
def nsdogbox(fun,grad,reg_grad,x0,lb=None,ub=None,initial_radius=None,threshold_radius=1e-3,verbose=0,xtol=1e-8,ftol=1e-8,gtol=1e-5,max_nfev=10000):

    if not lb:
        lb = 1e-8*np.ones_like(x0)
    if not ub:
