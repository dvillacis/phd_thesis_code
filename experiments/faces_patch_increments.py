...
out_dir = 'faces_patch_increments_reg'
...
with open(summary_table_dir,'w+') as f:
    ...
    for patch in patch_sizes:
        ...
        cmd = f'python ../regularization_learning.py ../datasets/faces_train_128_5/filelist.txt -t patch -ps {str(patch)} -i {str(alpha0)} -o {os.path.join(out_dir,str(patch))} -v'
        os.system(cmd)
